...
/**
  ...
  */
final class DefaultQueueStatusTracker @Inject()(naming: QueueNaming, helpers: QueueHelpers, failureTiming: RecentResourceContention) extends QueueStatusTracker {
